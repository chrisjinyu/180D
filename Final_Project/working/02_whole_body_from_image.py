...
FORGIVE_DIST = 12 #inches players can move when not allowed to move without penalty
...
def checkAndAdminGesture(playerNum):
	...
	if float(distances[playerIndex]) < WIN_DIST:
			print("\n\nPlayer %d come and face me and prepare to perform the holy gesture to declare your loyalty to me" % (playerNum))
			if recogGesture(2):
...
def recogGesture(gestureNum):
	...
	print("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\nT-Pose to display your loyalty to me")
	while cap.isOpened():
...
if __name__ == "__main__": 
	...
	try:
		...
		print("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\nYou two were part of a large group of adventurers")
		...
		#time.sleep(INTERMESSAGE_TIME)
		print("\nPrepare yourselves, only one shall succeed....")
		time.sleep(INTERMESSAGE_TIME)
